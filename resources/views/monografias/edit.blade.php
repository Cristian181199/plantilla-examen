<x-contenido>
    ...
    <form action="{{ route('monografias.update', [$monografia], false) }}" method="POST">
        @csrf
        @method('PUT')
        <h1 class="text-center text-2xl font-bold text-gray-500 mb-10">EDITAR MONOGRAFIA</h1>
        <div class="space-y-4">
            <div>
            ...
            <button type="submit" class=" px-6 py-2 mx-auto block rounded-md text-lg font-semibold text-indigo-100 bg-indigo-600">Editar monografia</button>
        </div>
        <div>
