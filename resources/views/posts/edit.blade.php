        ...
        <div class=" bg-white rounded-md px-6 py-10 max-w-2xl mx-auto">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="title" placeholder="titulo" id="title" class="ml-2 outline-none py-1 px-2 text-md border-2 rounded-md @error('title') border-red-500 @enderror" value="{{old('title', $post->title)}}"/>
                    @error('title')
                ...
                <div>
                    ...
                    <textarea id="body" name="body" cols="30" rows="10" placeholder="Escribe aqui.." class="w-full font-serif  p-4 text-gray-600 outline-none rounded-md @error('body') border-red-500 @enderror">{{old('body', $post->body)}}</textarea>
                    @error('body')
                        <span class="flex items-center font-medium tracking-wide text-red-500 text-xs mt-1 ml-1">
                            {{ $message }}
                        </span>
